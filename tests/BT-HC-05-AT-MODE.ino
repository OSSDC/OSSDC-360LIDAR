...
//
//  Follow the steps here to enter AT mode (this script is from this page):
//  http://www.martyncurrey.com/arduino-with-hc-05-bluetooth-module-at-mode/
//
//  Then send from Serial Monitor "AT+UART=115200,1,0" to set 115200 baud BTserial speed
